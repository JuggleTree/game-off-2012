goog.provide('lime.ASSETS.JuggleTextures.json');
goog.require('soy');

lime.ASSETS.JuggleTextures.json.data = function(opt_data) { 
return {"frames": {
